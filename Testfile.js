...
const gameData = {
  ...
  foundCoins: { question: 'You found old coins! (End)', answers: [] },
  lost: { question: 'You got lost!! (End)', answers: [] },
  foundGold: { question: 'Yeah!! You found a bag full of gold. (End)', answers: [] },
  exit: { question: 'You got the way to exit. (End)', answers: [] },
  path2: {
  ...
  lifetimeHappiness: { question: 'You got a lifetime Happiness wish! (End)', answers: [] },
  hiddenPath: { question: 'You enjoy the view and find a hidden path. (End)', answers: [] },
  safelyReach: { question: 'You reach the other side safely. (End)', answers: [] },
  path3: {
  ...
  treasury: { question: 'You got some treasury. (End)', answers: [] },
  enjoyDay: { question: 'You enjoy a beautiful day. (End)', answers: [] },
  boredSad: { question: 'You got bored and sad after a period. (End)', answers: [] }
};
...
function renderQuestion() {
  ...
  nextButton.style.display =
    currentData.answers.length === 0 && completedPaths.length > 0 ? 'block' : 'none';
